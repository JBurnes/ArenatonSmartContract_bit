...
library EventsLib {
    ...
    /**
     * @dev This event is triggered when a user decides to cancel their previously placed stake on an event.
     *
     * @param eventIdIndexed - A indexed version of the event's unique identifier.
     *
     * @param playerIndexed - A indexed version of the player's address who canceled the stake.
     *
     * @param eventId - The unique identifier of the sports event where the stake was canceled.
     *
     * @param player - The address of the player who canceled the stake.
     *
     * @param amountVUND - The amount of VUND tokens that were originally staked and now refunded.
     *
     * @param amountATON - The amount of ATON tokens that were originally staked and now refunded.
     *
     * @param team - The team the player had originally chosen to stake on.
     */
    event StakeCanceled(
        string indexed eventIdIndexed,
        address indexed playerIndexed,
